...
ggplot(df, aes(x = objective.om_capitalTotal, y = objective.om_sumBiomass, colour = nbBoats))+
  geom_point()+
  theme_bw()


ggplot(df, aes(x = objective.om_capitalTotal, y = objective.om_sumBiomass, colour = ReserveIntegrale))+
  geom_point()+
  theme_bw()
